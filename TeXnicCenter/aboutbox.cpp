...
LPCTSTR const pArrCredit[] =
{
	...
	_T(""),
	_T(""),
	_T("Editor with Syntax Highlighting\t"),
	_T(""),
	_T("Andrei Stcherbatchenko\f"),
	_T("Paul Selormey, James R. Twine, Sven Wiegand\f"),
	_T(""),
	_T(""),
	_T("Spell Checker based on Speller\t"),
	_T(""),
	_T("Kevin B. Hendricks\f"),
	_T(""),
	_T(""),
	_T("Additional Codes\t"),
	_T(""),
