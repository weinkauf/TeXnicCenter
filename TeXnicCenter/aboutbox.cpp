...
// in the array!
#define ARRAYCOUNT		83
char *pArrCredit[] = {
						"Copyright © 1999-2001\t",
						"www.ToolsCenter.org\t",
						"",
						"Portions Copyright © 1998-2001 by BCGSoft Ltd\f",
						"Portions Copyright © 1998-2001 by Cristi Posea\f",
						"",
						"",
						"IDB_SEPARATOR\b",
						"",
						...
						"Additional Codes\t",
						"",
						"Adam Clauss, Michael Dunn, Mark Findlay, Martin Stanek\f",
						"",
						"",
						"IDB_SEPARATOR\b",
						"",
						...
						"Tests & Suggestions\r",
						"",
						"Albrecht Mehl, Klaus Ondrich, Carsten Paul\f",
						"and many others...\f",
						"",
						"Special thanks to all the users at the TeXnicCenter-Users mailing list\f",
