...
#define TXC_PLACEHOLDERSET_TEXFILES 1
#define TXC_PLACEHOLDERSET_BIBTEXFILES 2
#define TXC_PLACEHOLDERSET_GRAPHICFILES 4
#define TXC_PLACEHOLDERSET_TXCFILES 8
#define TXC_PLACEHOLDERSET_CURRENTLYOPENEDFILES 16
...
This allows the following syntax for a given string (@see ExpandAllSets):

<b><tt>$[q][s][f][r]<FILESET></tt></b>

<ul>
	<li><b><tt>$</tt></b> Starts the Placeholder. Use "$$" to get "$".

	<li><b><tt>q</tt></b> Filenames will be quoted using ".<br>

	<li><b><tt>s</tt></b> Filenames in 8.3-format.<br>

	<li><b><tt>f</tt></b> Forward Slash '/' is used as Directory Separator.<br>

	<li><b><tt>r</tt></b> Filenames will be given relative to the WorkingDir of the Project (@see SetProject).

	<li><b><tt><FILESET></tt></b> One of the following:

	<ul>
		<li><b><tt>TPF</tt></b> All TeX-Files reported in <var>m_aStructureItems</var> of the Project (@see SetProject).
		<li><b><tt>BPF</tt></b> All BibTeX-Files reported in <var>m_aStructureItems</var> of the Project (@see SetProject).
		<li><b><tt>GPF</tt></b> All Graphic-Files reported in <var>m_aStructureItems</var> of the Project (@see SetProject).
		<li><b><tt>TXC</tt></b> All Files generated by TXC regarding the Project (@see SetProject). Currently only the .tcp and .tps files.
		<li><b><tt>COF</tt></b> All currently opened Files in the Editor.
		<li><b><tt>APF</tt></b> All Project Files. This is the sum of <b><tt>TPF</tt></b>, <b><tt>BPF</tt></b>, <b><tt>GPF</tt></b> and <b><tt>TXC</tt></b>.
		<li><b><tt>AFS</tt></b> All above Filesets together. This is the sum of <b><tt>TPF</tt></b>, <b><tt>BPF</tt></b>, <b><tt>GPF</tt></b>, <b><tt>TXC</tt></b> and <b><tt>COF</tt></b>.
	</ul>
</ul>
...
<ul>
	<li><b><tt>$qTPF</tt></b> Lists all TeX-Files reported by TXC-StructureParser. \n
				...
				like <tt>"D:\Temp\test\curvature3d.tex" "D:\Temp\test\definitions\macros.tex" "D:\Temp\test\chaptertwo.tex"</tt>
	...
	<li><b><tt>$fBPF</tt></b> Lists all BibTeX-Files reported by TXC-StructureParser. \n
				...
				like <tt>D:/Temp/test/xbib.bib D:/Temp/test/morebibs/morexbib.bib</tt>
	...
	<li><b><tt>$COF</tt></b> Lists all Files opened in the editor. \n
				...
				like <tt>D:\Temp\test\curvature3d.tex D:\Program Files\texmf\pdftex\latex\config\pdflatex.ini</tt>
	...
	<li><b><tt>$qsrAPF</tt></b> Lists all Files contained in the Project (as reported by TXC-StructureParser). \n
				...
				like <tt>"curvat~1.tcp" "curvat~1.tps" "curvat~1.tex" "..\..\Progra~1\texmf\pdftex\latex\config\pdflatex.ini" "xbib.bib" "morebibs\morexb~1.bib" "defini~1\macros.tex" "chapte~1.tex"</tt>
</ul>
...
public:
	...
	*/
	...
	@param bRelativePaths
		Filenames will be given relative to the WorkingDir of the Project (@see SetProject)
...
protected:
	...
	*/
	void CPlaceholderSets::ConvertAndAdd(CString& strToAdd, CUniqueStringList* pStrList,
											const bool bShortPaths, const bool bForwardSlash,
