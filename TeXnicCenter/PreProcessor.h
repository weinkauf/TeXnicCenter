...
class CPreProcessorArray : public CArray<class CPreProcessor, class CPreProcessor&>
	...
	public:
		 ...
		 */
		void SaveXml(MsXml::CXMLDOMElement xmlPreProcessors) const;
...
public:
	CPreProcessor(LPCTSTR lpszTitle = _T(""), LPCTSTR lpszPath = _T(""),
...
public:
	...
	@exception CComException
	 */
	void SaveXml(MsXml::CXMLDOMElement xmlPreProcessor) const;
	...
	@exception CComException
	 */
	void LoadXml(MsXml::CXMLDOMElement xmlPreProcessor);
