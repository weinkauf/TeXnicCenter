...
bool CConfiguration::IsWordWrapIndentEnabled() const
{
	return word_wrap_indent_ != 0;
}
...
bool CConfiguration::IsFoldingEnabled() const
{
	return fold_;
}

void CConfiguration::EnableFolding(bool val /*= true*/)
{
	fold_ = val;
}
