...
IMPLEMENT_DYNCREATE(COutputWizardWelcome, CPropertyPage)

COutputWizardWelcome::COutputWizardWelcome() : CPropertyPage(COutputWizardWelcome::IDD)
{
...
BEGIN_MESSAGE_MAP(COutputWizardWelcome, CPropertyPage)
	//{{AFX_MSG_MAP(COutputWizardWelcome)
