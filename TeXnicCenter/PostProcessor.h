...
inline
CString CPostProcessor::GetTitle() const
{
	return m_strTitle;
}
...
inline
CString CPostProcessor::GetPath() const
{
	return m_strPath;
}
...
inline
CString CPostProcessor::GetArguments() const
{
...
inline
CString CPostProcessor::GetInputFile() const
{
...
inline
CString CPostProcessor::GetOutputFile() const
{
