...
Bei Verwendung bestimmter Schriftarten gibt es jedoch Probleme mit Umlauten.
Dies wird im folgenden Abschnitt beschrieben.


\section{Automatische Silbentrennung}\label{silbentrennung}
Im folgenden Text sollte das lange Wort automatisch von \LaTeX\ getrennt werden.
Bei Verwendung bestimmter Schriftarten hat \LaTeX\ jedoch Probleme mit der
automatischen Silbentrennung von Wörtern, die Umlaute usw.\ enthalten.

Test: Ein langes WortmiteinemUmlautäodergarzweiUmlautenöüumzutestenobLaTeXdieSilbentrennungschafft.

Wenn das lange Wort über den Rand hinaus geht, dann hat die
automatische Silbentrennung nicht funktioniert.
Sie lösen das Problem wie folgt:

\begin{itemize}
\item \textbf{Empfohlen}\\
Installieren Sie die cm-super Fonts. Das sind Schriftarten für Ihr \LaTeX-System
und hat nichts mit TeXnicCenter selbst zu tun. Falls Sie mik\TeX\ arbeiten,
starten Sie bitte den mik\TeX\ Package Manager ("`Browse Packages"' im Startmenü).
Dort finden Sie dann die cm-super Fonts. Achtung: Das Paket ist sehr groß (ca.\ 70MB).
Dann geht die Silbentrennung wieder.

\item \textbf{Nicht ganz vollwertige Alternative}\\
Binden Sie die Pakete \verb#\usepackage{ae, aeguill}# ein.
Dann geht zwar die Silbentrennung, jedoch können Sie dann
z.B.\ im Adobe Reader nicht mehr nach Worten mit Umlauten suchen.
