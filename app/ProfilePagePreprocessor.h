...
#if !defined(AFX_PROFILEPAGEPREPROCESSOR_H__5C552766_082E_11D5_A222_006097239934__INCLUDED_)
#define AFX_PROFILEPAGEPREPROCESSOR_H__5C552766_082E_11D5_A222_006097239934__INCLUDED_
...
/**	Edits the Preprocessors of output profiles.
...
@author Sven Wiegand
 */
class CProfilePagePreprocessor : public CProfilePage
{
// construction/destruction
public:
	CProfilePagePreprocessor();
...
//{{AFX_VIRTUAL(CProfilePagePreprocessor)
protected:
...
protected:
	...
	//{{AFX_MSG(CProfilePagePreprocessor)
...
// dialog field data
protected:
	//{{AFX_DATA(CProfilePagePreprocessor)
	enum
	{
		IDD = IDD_PROFILE_PREPROCESSOR
	};
	CEdit m_wndExe;
	...
	CBrowseButton m_wndBrowsePreprocessor;
	//}}AFX_DATA
...
#endif // AFX_PROFILEPAGEPREPROCESSOR_H__5C552766_082E_11D5_A222_006097239934__INCLUDED_
